...
CREATE TABLE IF NOT EXISTS `speedtest`.`result` (
  ...
  `packetLoss` INT NULL,
  `isp` VARCHAR(45) NULL,
  `interface_internalIp` VARCHAR(45) NULL,
  `interface_name` VARCHAR(45) NULL,
  `interface_macAddr` VARCHAR(45) NULL,
  `interface_isVpn` TINYINT NULL,
  `interface_externalIp` VARCHAR(60) NULL,
  `server_id` INT NOT NULL,
  `server_host` VARCHAR(255) NULL,
  `server_port` INT NULL,
  `server_name` VARCHAR(60) NULL,
  `server_location` VARCHAR(60) NULL,
  `server_country` VARCHAR(60) NULL,
