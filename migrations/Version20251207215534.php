...
final class Version20251207215534 extends AbstractMigration
{
    ...
    private function result(): string
    {
        return 'CREATE TABLE `speedtest`.`result` (
                    ...
                    `ping_jitter` DECIMAL(10,3) NULL,
                    `ping_latency` DECIMAL(10,3) NULL,
                    `ping_low` DECIMAL(10,3) NULL,
                    `ping_high` DECIMAL(10,3) NULL,
                    `download_bandwidth` INT NULL,
                    `download_bytes` INT NULL,
                    `download_elapsed` INT NULL,
                    `download_latency_iqm` DECIMAL(10,3) NULL,
                    `download_latency_low` DECIMAL(10,3) NULL,
                    `download_latency_high` DECIMAL(10,3) NULL,
                    `download_latency_jitter` DECIMAL(10,3) NULL,
                    `upload_bandwidth` INT NULL,
                    `upload_bytes` INT NULL,
                    `upload_elapsed` INT NULL,
                    `upload_latency_iqm` DECIMAL(10,3) NULL,
                    `upload_latency_low` DECIMAL(10,3) NULL,
                    `upload_latency_high` DECIMAL(10,3) NULL,
                    `upload_latency_jitter` DECIMAL(10,3) NULL,
